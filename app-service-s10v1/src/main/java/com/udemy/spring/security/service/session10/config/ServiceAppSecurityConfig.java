...
import com.udemy.spring.security.service.session09.filter.*;
import com.udemy.spring.security.service.session10.filter.*;
...
public class ServiceAppSecurityConfig {
  ...
  SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
    ...
    http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
            ...
            // must be executed AFTER a successful authentication process
            .addFilterAfter(new JWTTokenGeneratorFilter(), BasicAuthenticationFilter.class)
            // must be executed BEFORE the basic authentication filter did by Spring Security
            //.addFilterAt(new JWTTokenValidatorFilter(), BasicAuthenticationFilter.class)
            // ---------------------------------------------------------------------------------------
